...
func <- my_data[,c(2,3,40,41,46:53,64)]
...
func2_s_scores_df_sig <- func2_s_scores_df[c(1,2,12),]
prok_h1 <- prok_h[,c(1,2,12)]
...
func2_s_scores_df_sig <- func2_s_scores_df[c(13, 7, 19),]
ITS2_hs <- ITS2_h[,c(13, 7, 19)]
...
func_s_scores_df_sig <- func_s_scores_df[c(22,5,31,17,37),]
env_s1 <- env_s[,c(22,5,31,17,37)]
...
func_s_scores_df_sig <- func_s_scores_df[c(1:2, 4, 14, 16:17, 20:22, 36:37),]
env_s1 <- env_s[,c(1:2, 4, 14, 16:17, 20:22, 36:37)]
